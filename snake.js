...
let domElements = {
    ...
    highscoreRef: document.querySelector('.high-score'),
...
let Game = {
    score: 0,
    speed: SpeedOptions.speedType.easy,
    context: undefined,
...
function setGameSpeed() {
    switch (Game.speed) {
        case SpeedOptions.speedType.easy: return SpeedOptions.baseSpeedIndex;
        case SpeedOptions.speedType.medium: return SpeedOptions.baseSpeedIndex * 0.70;
        case SpeedOptions.speedType.hard: return SpeedOptions.baseSpeedIndex *= 0.98;
    }
}
...
function checkSpeedChoice(e) {
    ...
    switch (choice.toLowerCase()) {
        case SpeedOptions.speedType.easy:
            Game.speed = SpeedOptions.speedType.easy;
            domElements.currentSpeedRef.textContent = Game.speed;
            break;
        case SpeedOptions.speedType.medium:
            Game.speed = SpeedOptions.speedType.medium;
            domElements.currentSpeedRef.textContent = Game.speed;
            break;
        case SpeedOptions.speedType.hard:
            Game.speed = SpeedOptions.speedType.hard;
            domElements.currentSpeedRef.textContent = Game.speed;
            break;
    }
}
...
function checkIfSnakeDies() {
    let sX = Snake.headPosition.x;
    let sY = Snake.headPosition.y;
let isSnakeHeadOutsideTheGameArea = sX < 1 || sY < 1 || sX >= Game.blockSize.width - 3 || sY >= Game.blockSize.height - 3;
...
/*function updateHighScore(){
    domElements.highscoreRef.textContent = 'High Score: ' + highscore;
}*/
...
function drawSnake() {
    ...
    for (let i = Snake.body.length - 1; i >= 0; i--) {
        ...
        Game.context.fillStyle = (i == Snake.body.length - 1) ? "blue" : "white";
